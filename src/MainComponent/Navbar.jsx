...
const Navbar = () => {
  ...
  return (
    <nav className="flex items-center justify-between flex-wrap bg-white py-0 lg:px-6 shadow border-solid border-t-2 border-gray-200 ">
      ...
      <div className="flex justify-between lg:w-auto w-full lg:border-b-0 pl-6 pr-2 border-solid border-b-2 border-gray-300 pb-3 lg:pb-0">
        <div className="flex items-center flex-shrink-0 text-gray-900 mr-16 mb-9z" >
          ...
          <span className="font-semibold text-xl tracking-tight cursor-pointer ">Converse</span>
        </div>
      ...
      >
        <div className="text-md font-bold text-neutral-500 lg:flex-grow">
          <a
            ...
            className="block mt-4 lg:inline-block lg:mt-0 hover:text-white px-4 py-2 rounded hover:bg-gray-950 mr-2"
          >
            Men
          </a>
          <a
        ...
        {/* Search Bar */}
        <div className="relative mx-auto text-gray-300 lg:block hidden ">
          <input
        ...
        <div className="flex cursor-pointer">
          <div className="block text-md px-4 py-2 rounded text-gray-600 ml-2 font-bold hover:text-white mt-4 hover:bg-gray-950 lg:mt-0"
>
            <button onClick={()=>Navigate("/singup")}>SING UP</button>
            
            </div>
          <div className=" block text-md px-4 ml-2 py-2 rounded text-gray-600 font-bold hover:text-white mt-4 hover:bg-gray-950 lg:mt-0"
>
